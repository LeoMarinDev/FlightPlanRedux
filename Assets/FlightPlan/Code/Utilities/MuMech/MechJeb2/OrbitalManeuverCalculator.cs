...
namespace MuMech
{
    public static class OrbitalManeuverCalculator
    {
        ...
        public static double GetLatitude(this IKeplerOrbit o, double UT)
        {
        ...
        public static double GetLatLon(this IKeplerOrbit o, double UT, out double longitude)
        {
        ...
        public static double GetLongitude(this IKeplerOrbit o, double UT)
        {
            double latitude, longitude, altitude;
            Position position = new Position(o.referenceBody.coordinateSystem, o.WorldPositionAtUT(UT));
            o.referenceBody.GetLatLonAltFromRadius(position, out latitude, out longitude, out altitude);
        ...
        public static Vector3d DeltaVToCircularize(IKeplerOrbit o, double UT)
        {
        ...
        public static Vector3d DeltaVToEllipticize(IKeplerOrbit o, double UT, double newPeR, double newApR)
        {
        ...
        public static Vector3d DeltaVToChangePeriapsis(IKeplerOrbit o, double ut, double newPeR)
        {
            double radius = o.Radius(ut);
        ...
        public static Vector3d DeltaVToChangeApoapsis(IKeplerOrbit o, double ut, double newApR)
        {
            double radius = o.Radius(ut);
        ...
        public static Vector3d DeltaVToChangeEccentricity(IKeplerOrbit o, double ut, double newEcc)
        {
            //sanitize input
        ...
        public static Vector3d DeltaVForSemiMajorAxis(IKeplerOrbit o, double ut, double newSMA)
        {
            (V3 r, V3 v) = o.RightHandedStateVectorsAtUT(ut);
        ...
        //If the given latitude is too large, so that an orbit with a given inclination never attains the
        //given latitude, then this function returns either 90 (if -90 < inclination < 90) or 270.
        public static double HeadingForLaunchInclination(IKeplerOrbit o, double inclinationDegrees)
        {
        ...
        public static Vector3d DeltaVToChangeInclination(IKeplerOrbit o, double UT, double newInclinationDeg)
        {
            (V3 r, V3 v) = o.RightHandedStateVectorsAtUT(UT);
        ...
        public static Vector3d DeltaVAndTimeToMatchPlanesAscending(IKeplerOrbit o, IKeplerOrbit target, double UT, out double burnUT)
        {
        ...
        public static Vector3d DeltaVAndTimeToMatchPlanesDescending(IKeplerOrbit o, IKeplerOrbit target, double UT, out double burnUT)
        {
        ...
        private static Vector3d DeltaVAndApsisPhaseAngleOfHohmannTransfer(IKeplerOrbit o, IKeplerOrbit target, double UT, out double apsisPhaseAngle, double offsetDist = 0)
        {
        ...
        public static ( Vector3d dV1, double UT1, Vector3d dV2, double UT2) DeltaVAndTimeForHohmannTransfer(IKeplerOrbit o, IKeplerOrbit target, double ut,
        ...
        //
        public static (Vector3d v1, Vector3d v2) DeltaVToInterceptAtTime(IKeplerOrbit o, double t0, IKeplerOrbit target, double dt,
        ...
        public static Vector3d DeltaVAndTimeForCheapestCourseCorrection(IKeplerOrbit o, double UT, IKeplerOrbit target, out double burnUT)
        {
        ...
        public static Vector3d DeltaVAndTimeForCheapestCourseCorrection(IKeplerPatch o, double UT, IKeplerOrbit target, CelestialBodyComponent targetBody, double finalPeR,
            out double burnUT)
        {
            double now = Game.UniverseModel.UniverseTime;
        ...
        public static Vector3d DeltaVAndTimeForCheapestCourseCorrection(IKeplerOrbit o, double UT, IKeplerOrbit target, double caDistance, out double burnUT)
        {
            Vector3d collisionDV = DeltaVAndTimeForCheapestCourseCorrection(o, UT, target, out burnUT);
            PatchedConicsOrbit collisionOrbit = o.PerturbedOrbit(burnUT, collisionDV);
            double collisionUT = collisionOrbit.NextClosestApproachTime(target, burnUT);
        ...
        public static Vector3d DeltaVAndTimeForInterplanetaryTransferEjection(IKeplerOrbit o, double UT, IKeplerOrbit target, bool syncPhaseAngle,
            out double burnUT)
        {
            IKeplerPatch planetOrbit = o.referenceBody.Orbit;
        ...
        public static (Vector3d dv, double dt) DeltaVAndTimeForMoonReturnEjection(IKeplerOrbit o, double ut, double targetPrimaryRadius)
        {
        ...
        public static Vector3d DeltaVAndTimeForHohmannLambertTransfer(IKeplerOrbit o, IKeplerOrbit target, double UT, out double burnUT, double subtractProgradeDV = 0)
        {
            Vector3d hohmannDV;
        ...
        //inclination change is nonzero you should also do a mid-course correction burn, as computed by
        //DeltaVForCourseCorrection (a function that has been removed due to being unused).
        public static Vector3d DeltaVAndTimeForInterplanetaryLambertTransferEjection(IKeplerOrbit o, double UT, IKeplerOrbit target, out double burnUT)
        {
            IKeplerPatch planetOrbit = o.referenceBody.Orbit;
        ...
        public static Vector3d DeltaVToMatchVelocities(IKeplerOrbit o, double UT, IKeplerOrbit target) =>
        ...
        public static Vector3d DeltaVToResonantOrbit(IKeplerOrbit o, double UT, double f)
        {
            double a = o.Apoapsis;
        ...
        public static Vector3d DeltaVToShiftLAN(IKeplerOrbit o, double UT, double newLAN)
        {
        ...
        public static Vector3d DeltaVToShiftNodeLongitude(IKeplerOrbit o, double UT, double newNodeLong)
        {
        ...
        // ============================ P4 STAGING BOUNDARY ==================================
        // Deleted: `PatchedConicInterceptBody(initial, target, dV, burnUT, arrivalUT, out intercept)`.
        // It ran the legacy "dummy node approach" through NodeManager - `NodeManagerPlugin.Instance
        // .CreateManeuverNodeAtUT(burnVec, burnUT, 0)` to plant a throwaway node, read the resulting
        // `PatchedConicsList`, then `DeleteNode(nodeIndex)` to remove it. NodeManager was a *NuGet
        // package* in the legacy build (FlightPlan.csproj: `<PackageReference Include="NodeManager"
        // Version="0.8.1" />`); on Redux there is no such package - the node service is absorbed
        // natively in P4 (`Code/Managers/FlightPlanNodeService.cs`).
        // Nothing in the port called this method, and its tail (after `return;`) was the legacy's
        // unreachable "Imitate the current MJ process" scratch block.
        // P4: if an SOI-intercept helper is wanted, rebuild it on `FlightPlanNodeService` using the
        // K2D2-proven create sequence and `ManeuverPlanComponent.UpdateNodeDetails`, not on
        // NodeManager.
        // ======================================================================================
        ...
        //
        //
        public static void SOI_intercept(IKeplerOrbit transfer, CelestialBodyComponent target, double UT1, double UT2, out double UT)
        {
