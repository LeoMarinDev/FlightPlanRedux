...
//
//   TypeLoadException: Could not load type of field 'FlightPlan.Plugin:_document' (0) due to:
...
internal static class ApiProbe
{
    private static int Main(string[] args)
    {
        ...
        // exists in the assembly, because a miss is counted as a failure. Phase 1 ships only the
        // plugin class; later phases append the window, the node service and the UI controller as
        // they are authored.
        foreach (var name in new[] { "FlightPlan.FlightPlanPlugin" })
        {
